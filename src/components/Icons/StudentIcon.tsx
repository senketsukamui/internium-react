...
const SvgStudent = (props: DefaultIconProps) => (
  ...
  >
    ...
    <path
      ...
      d="m67 67.997-2-1H45l-2 1L55 87z"
    />
    <path
    ...
    />
    <path
      d="M61 47.322c1.191 0 2.248.266 2.981.678.071-.569-.172-1.154-.748-1.59-1.03-.781-2.702-.781-3.733 0-.464.352-.709.801-.753 1.26A7.068 7.068 0 0 1 61 47.322zM48.993 47.322c-1.191 0-2.248.266-2.981.678-.071-.569.172-1.154.748-1.59 1.03-.781 2.702-.781 3.733 0 .464.352.709.801.753 1.26a7.068 7.068 0 0 0-2.253-.348z"
      style={{
        fill: "#3e3e3f",
      }}
    />
    ...
    />
    <path
      d="M50.105 66.993 45 62.997v4.5s0 7.5 10 7.5v-7h-2.655a2.999 2.999 0 0 1-2.24-1.004z"
      style={{
        fill: "#f8e1c2",
      }}
    />
    ...
    <path
      ...
      d="M66.965 68.059 67 68l-2-1-9.985 4.981 5.793 5.826z"
    />
    <path
      style={{
        fill: "#df2c2c",
    ...
    <path
      ...
      d="M43.035 68.059 43 68l2-1 9.985 4.981-5.793 5.826z"
    />
    <path
    ...
    <path
      ...
      d="M55 87 43 68l-9 3 17 16zM55 87l12-19 9 3-17 16z"
    />
  </svg>
);
